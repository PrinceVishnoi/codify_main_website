  ...
  return (
    <>
      <div id="maindiv" style={{ position: 'relative', height: '700px', textAlign: 'center' }}>
        <video src={require('./MainPageVideo.mp4')} autoPlay loop muted style={{ position: 'absolute', left: 0, top: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.7 }} alt="Custom Web Development, App Development, and UI/UX Design Services video"></video>
