        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              ...
              <p>
                We're here to listen! Whether you have a question, want to
                discuss a project, or simply want to say hello, we're all ears.
                You can reach us by phone, email, or by filling out the contact
                form on this page. We'll get back to you as soon as possible!
              </p>
            </MDBCol>
